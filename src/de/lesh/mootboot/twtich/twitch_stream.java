...
public class twitch_stream
	...
	public boolean isOnline()
	{
		...
		public void setBroadcast_part(int broadcast_part) { this.broadcast_part = broadcast_part; }
		public boolean isFeatured() {
		return this.featured; }
		public void setFeatured(boolean featured) { this.featured = featured; }
		public boolean isChannel_subscription() {
		return this.channel_subscription; }
		public void setChannel_subscription(boolean channel_subscription) { this.channel_subscription = channel_subscription; }
		public String getId() {
		return this.id; }
		...
		public void setChannel_count(int channel_count) { this.channel_count = channel_count; }
		...
		public void setSite_count(int site_count) { this.site_count = site_count; }
		public boolean isEmbed_enabled() {
		return this.embed_enabled; }
		public void setEmbed_enabled(boolean embed_enabled) { this.embed_enabled = embed_enabled;
	}
	...
	{
		return this.up_time; }
		public void setUp_time(String up_time) { this.up_time = up_time; }
		public String getMeta_game() {
		return this.meta_game; }
		public void setMeta_game(String meta_game) { this.meta_game = meta_game; }
		public String getFormat() {
		return this.format; }
		public void setFormat(String format) { this.format = format; }
		public int getEmbed_count() {
		return this.embed_count; }
		public void setEmbed_count(int embed_count) { this.embed_count = embed_count; }
		...
		public void setAbuse_reported(boolean abuse_reported) { this.abuse_reported = abuse_reported; }
		public int getVideo_width() {
		return this.video_width; }
		public void setVideo_width(int video_width) { this.video_width = video_width; }
		...
		public void setVideo_bitrate(double video_bitrate) { this.video_bitrate = video_bitrate; }
		...
		public void setChannel_view_count(int channel_view_count) { this.channel_view_count = channel_view_count; 
	}
	...
	public String getSubcategory_title()
	{
		...
		public void setSubcategory_title(String subcategory_title) { this.subcategory_title = subcategory_title; }
		public String getScreen_cap_url_large() {
		return this.screen_cap_url_large; }
		public void setScreen_cap_url_large(String screen_cap_url_large) { this.screen_cap_url_large = screen_cap_url_large; }
		public String getScreen_cap_url_small() {
		return this.screen_cap_url_small; }
		public void setScreen_cap_url_small(String screen_cap_url_small) { this.screen_cap_url_small = screen_cap_url_small; }
		public String getScreen_cap_url_medium() {
		return this.screen_cap_url_medium; }
		public void setScreen_cap_url_medium(String screen_cap_url_medium) { this.screen_cap_url_medium = screen_cap_url_medium; }
		public String getScreen_cap_url_huge() {
		return this.screen_cap_url_huge; }
		public void setScreen_cap_url_huge(String screen_cap_url_huge) { this.screen_cap_url_huge = screen_cap_url_huge; }
		...
		public void setViews_count(int views_count) { this.views_count = views_count;
	}
}
